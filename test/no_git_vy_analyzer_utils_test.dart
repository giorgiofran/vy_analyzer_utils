...
void main() async {
  ...
  group('Test Extractors', () {
    test('Test DartObject', () {
      ...
      var member = testClassDeclaration?.members[3];
      if (member is FieldDeclaration) {
        ...
        ///var tv = testClassDeclaration?.declaredElement?.getMethod('testValues');
        var med = testClassDeclaration?.members.last;
      ...
      print(source?.substring(ele?.nameOffset ?? 0,
          (ele?.nameOffset ?? 0 + (ele?.nameLength ?? source.length))));
